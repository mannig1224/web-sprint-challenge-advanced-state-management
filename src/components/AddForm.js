...
import { postSmurf, addError} from '../actions';
...
const AddForm = (props) => {
    ...
    const { postSmurf, addError, error} = props;
...
export default connect(mapStateToProps, { postSmurf, addError})(AddForm);
